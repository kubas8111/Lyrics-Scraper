...
planets = [
    Circle(pygame.Vector2(0, 0), pygame.Vector2(0, 0), 30, color.YELLOW, 1.9891e30, "Sun"),
    Circle(pygame.Vector2(0 + 5.79e7, 0), pygame.Vector2(0, 0), 4, color.BROWN, 3.302e23, "Mercury"),
    Circle(pygame.Vector2(0 + 1.08e8, 0), pygame.Vector2(0, 0), 9, color.ORANGE, 4.8685e24, "Venus"),
    Circle(pygame.Vector2(0 + 1.496e8, 0), pygame.Vector2(0, 0), 10, color.BLUE, 5.9742e24, "Earth"),
    Circle(pygame.Vector2(0 + 2.279e8, 0), pygame.Vector2(0, 0), 5, color.RED, 6.419e23, "Mars"),
    Circle(pygame.Vector2(0 + 7.784e8, 0), pygame.Vector2(0, 0), 30, color.GOLD, 1.8986e27, "Jupiter"),
    Circle(pygame.Vector2(0 + 1.4267e9, 0), pygame.Vector2(0, 0), 25, color.OLIVE, 5.685e26, "Saturn"),
    Circle(pygame.Vector2(0 + 2.871e9, 0), pygame.Vector2(0, 0), 18, color.LIGHT_GRAY, 8.6841e25, "Uranus"),
    Circle(pygame.Vector2(0 + 4.498e9, 0), pygame.Vector2(0, 0), 16, color.CYAN, 1.0244e26, "Neptun"),
]
